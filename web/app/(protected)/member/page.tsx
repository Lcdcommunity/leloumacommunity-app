    ...
    <AppShell title="Espace membre">
      ...
      {data && (
        <div className="mb-wrap">
          ...
          {/* 🔥 CORRIGÉ : VirtualCardWidget n'accepte que `card` (et
              optionnellement `showPaymentLink`) — plus de visible/
              onToggleVisible, la bascule d'affichage est gérée en interne. */}
          {data.virtualCard && <VirtualCardWidget card={data.virtualCard} />}
      ...
      <button className="mb-fab" onClick={() => router.push('/member/contributions/new')}>
