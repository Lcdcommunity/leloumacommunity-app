...
export default function MemberSettingsPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setMessage({ text: 'Erreur lors de l\'enregistrement des préférences.', ok: false });
    } finally {
      setSaving(false);
    }
  }
            ...
            <div className="ms-panel-left" style={{ animationDelay: '.15s' }}>
              <div className="ms-panel">
                <div className="ms-panel-head">
                  ...
                  <span className="ms-panel-title">Sécurité du compte</span>
                </div>
