  ...
  useEffect(() => {
    async function fetchUser() {
      try {
        ...
        if (!found) {
          throw new Error('Administrateur introuvable dans la liste.');
        }
        ...
        >
          <div
            style={{
              width: 22,
              height: 22,
              border: '2.5px solid rgba(220,38,38,.12)',
              borderTopColor: '#DC2626',
              borderRadius: '50%',
              animation: 'saddspin .8s linear infinite',
            }}
          />
    ...
    <AppShell title={`Profil : ${fullName(user)}`}>
      <style>{`
        ...
        .sadd-eyebrow {
          ...
          opacity: 0;
          transform: translateY(8px);
          animation: saddin .45s .05s cubic-bezier(.22,1,.36,1) forwards;
        }
        ...
        .sadd-dot {
          ...
          background: #DC2626;
          border-radius: 50%;
          animation: saddpulse 2s ease-in-out infinite;
        }
        ...
        .sadd-page-title {
          ...
          opacity: 0;
          transform: translateY(8px);
          animation: saddin .45s .06s cubic-bezier(.22,1,.36,1) forwards;
        }

        .sadd-page-title span {
          color: #DC2626;
        }
        ...
        .sadd-hero {
          ...
          box-shadow: 0 4px 24px rgba(220,38,38,.08), 0 1px 2px rgba(0,0,0,.04);
          padding: 1.5rem;
          margin-bottom: 1rem;
          opacity: 0;
          transform: translateY(10px);
          animation: saddin .5s .08s cubic-bezier(.22,1,.36,1) forwards;
          position: relative;
          overflow: hidden;
        }
        ...
        .sadd-btn-suspend:hover:not(:disabled) {
          background: #FEF3C7;
        ...
        .sadd-btn-del:hover:not(:disabled) {
          background: #FEF2F2;
          border-color: rgba(220,38,38,.4);
          transform: translateY(-1px);
        }

        .sadd-btn-edit:disabled,
        .sadd-btn-suspend:disabled,
        .sadd-btn-del:disabled,
        .sadd-btn-cancel-edit:disabled {
          opacity: .55;
          cursor: not-allowed;
        }
        ...
        .sadd-card {
          ...
          box-shadow: 0 4px 24px rgba(220,38,38,.06), 0 1px 2px rgba(0,0,0,.03);
          overflow: hidden;
          margin-bottom: 1rem;
          opacity: 0;
          transform: translateY(10px);
        ...
        .sadd-edit-panel {
          animation: saddin .45s .12s cubic-bezier(.22,1,.36,1) forwards;
        }
        ...
        .sadd-section-divider {
          flex: 1;
          height: 1px;
          background: linear-gradient(90deg, rgba(220,38,38,.18), transparent);
          min-width: 60px;
        }
        ...
        .sadd-edit-section:last-of-type {
          margin-bottom: 0;
        }

        .sadd-edit-section-title {
          font-size: .66rem;
          font-weight: 800;
          letter-spacing: .1em;
          text-transform: uppercase;
        ...
        .sadd-btn-save:hover:not(:disabled) {
          transform: translateY(-1px);
          box-shadow: 0 6px 18px rgba(220,38,38,.36);
        }
        ...
        .sadd-btn-cancel-save:hover:not(:disabled) {
          background: #FEF2F2;
          border-color: rgba(220,38,38,.38);
        }

        .sadd-btn-save:disabled,
        .sadd-btn-cancel-save:disabled {
          opacity: .6;
          cursor: not-allowed;
        }
      ...
      <div className="sadd-wrap">
        ...
        <div className="sadd-hero">
                ...
                >
                  <span
                    style={{
                      ...
                      height: 5,
                      borderRadius: '50%',
                      background: user.status === 'ACTIVE' ? '#059669' : '#DC2626',
                      flexShrink: 0,
                    }}
                  />
          ...
          <div className="sadd-actions-desktop">
            {!isEditing ? (
              ...
              <button
                type="button"
                className="sadd-btn-cancel-edit"
              ...
              {busy ? (
                <div
                  style={{
                    ...
                    borderRadius: '50%',
                    animation: 'saddspin .7s linear infinite',
                  }}
                />
              ) : (
                <svg
          ...
          <div className="sadd-actions-mobile">
            {!isEditing ? (
              <button
                type="button"
                className="sadd-btn-icon sadd-icon-edit"
                onClick={() => {
                  setIsEditing(true);
                  setSaveOk(false);
                  setSaveError(null);
              ...
              <button
                type="button"
                className="sadd-btn-icon sadd-icon-cancel"
                onClick={handleCancelEdit}
              >
                <svg
                  width="15"
            ...
            <button
              type="button"
              className="sadd-btn-icon sadd-icon-suspend"
              disabled={busy}
              onClick={() => void handleToggleStatus()}
            >
              {busy ? (
            ...
            <button
              type="button"
              className="sadd-btn-icon sadd-icon-del"
              disabled={busy}
              onClick={() => void handleDelete()}
            >
              <svg
          ...
          <div className="sadd-edit-panel">
            ...
            <div className="sadd-edit-body">
              ...
              <div className="sadd-edit-footer">
                ...
                <button
                  type="button"
                  className="sadd-btn-cancel-save"
                  disabled={saving}
                  onClick={handleCancelEdit}
                >
                  Annuler
        ...
        <div className="sadd-card d1">
          <div className="sadd-card-h">
            <div
              className="sadd-card-ico"
              style={{ background: 'rgba(254,242,242,.8)', color: '#DC2626' }}
            >
              <svg
                width="13"
                height="13"
          ...
          <div className="sadd-grid">
            ...
            <div className="sadd-field">
              ...
              <span className={`sadd-field-value${user.phone ? '' : ' empty'}`}>
                {user.phone ?? '—'}
              </span>
            </div>
        ...
        <div className="sadd-card d2">
          ...
          <div className="sadd-grid">
            ...
            <div className="sadd-field">
              ...
              <span className={`sadd-field-value${user.postalCode ? '' : ' empty'}`}>
                {user.postalCode ?? '—'}
              </span>
            </div>
            ...
            <div className="sadd-field">
              ...
              <span className={`sadd-field-value${user.city ? '' : ' empty'}`}>
                {user.city ?? '—'}
              </span>
            </div>
            ...
            <div className="sadd-field">
              ...
              <span className={`sadd-field-value${user.country ? '' : ' empty'}`}>
                {user.country ?? '—'}
              </span>
            </div>
            ...
            <div className="sadd-field">
              ...
              <span
                className={`sadd-field-value${user.originSubPrefecture ? '' : ' empty'}`}
              >
