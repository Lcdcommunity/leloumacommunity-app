  ...
  return (
    <AppShell title="Super-Admin — Antennes">
      <style>{`
        ...
        .sa-stat { display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; background: rgba(253,253,255,.93); border-radius: 14px; border: 1px solid rgba(220,38,38,.09); border-top: 3px solid; box-shadow: 0 2px 8px rgba(220,38,38,.04); padding: .8rem .5rem; }
        ...
        .sa-panel-ico { width: 28px; height: 28px; border-radius: 8px; background: linear-gradient(135deg,#991B1B,#DC2626); display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 2px 8px rgba(220,38,38,.3); }
        ...
        .sa-toolbar { padding: .9rem 1.4rem; border-bottom: 1px solid rgba(220,38,38,.07); width: 100%; box-sizing: border-box; }
        ...
        .sa-search { width: 100%; height: 42px; border-radius: 11px; border: 1px solid rgba(220,38,38,.15); background: rgba(255,255,255,.9); padding: 0 .9rem 0 2.4rem; font-family: 'DM Sans', sans-serif; font-size: .84rem; font-weight: 500; color: #111827; outline: none; transition: border-color .2s, box-shadow .2s; box-sizing: border-box; }
        ...
        .sa-search-btn { flex: 0 0 auto; height: 42px; padding: 0 1.2rem; border-radius: 11px; background: linear-gradient(135deg,#991B1B,#DC2626); border: none; color: white; cursor: pointer; font-family: 'DM Sans', sans-serif; font-size: .82rem; font-weight: 800; display: flex; align-items: center; gap: .4rem; box-shadow: 0 3px 10px rgba(220,38,38,.3); transition: all .18s; white-space: nowrap; }
        ...
        @media (max-width: 640px) {
          .sa-header { align-items: center; margin-bottom: 1.25rem; }
          .sa-title { font-size: 1.4rem !important; }
          .sa-new-btn { height: 38px; padding: 0 0.85rem; font-size: 0.75rem; }
          
          /* 3 Stats sur la même ligne (compressées) */
          .sa-stats { grid-template-columns: repeat(3, 1fr); gap: 0.4rem; }
          .sa-stat { padding: 0.6rem 0.2rem; border-radius: 10px; }
          .sa-stat-val { font-size: 1.3rem; }
          .sa-stat-lbl { font-size: 0.55rem; }
        }

        @media (max-width: 500px) {
          /* Toolbar sur une ligne */
          .sa-search-row { gap: 0.4rem; }
          .sa-search { height: 38px; font-size: 0.75rem; padding-left: 2rem; }
          .sa-si { left: 0.6rem; width: 14px; height: 14px; }
          .sa-search-btn { height: 38px; padding: 0 0.8rem; font-size: 0.75rem; }
      ...
      <div className="sa-wrap">
        ...
        <div className="sa-header">
          ...
          <Link href="/super-admin/antennas/new" className="sa-new-btn">
            ...
            <span className="btn-text-desktop">Nouvelle antenne</span>
          </Link>
        </div>

        {/* STATISTIQUES (3 CARTES SUR UNE LIGNE) */}
