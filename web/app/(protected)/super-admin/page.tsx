          ...
          <div className="sa-stats">
            {stats.map((s, i) => (
              ...
              >
                ...
                {s.wide ? (
                  <>
                    <div className="sa-stat-icon" style={{ background: s.bg, color: s.color, width: 44, height: 44, borderRadius: 13 }}>
                      {s.icon}
                    </div>
                    <div>
                      <div className="sa-stat-label" style={{ marginBottom: '0.3rem' }}>{s.label}</div>
          ...
          <div className="sa-grid2">
            ...
            <div className="sa-panel" style={{ animationDelay: '0.52s' }}>
              ...
              <table className="sa-table">
                <thead>
                  <tr><th>Membre</th><th>Rôle</th><th>Statut</th><th>Date</th></tr>
                </thead>
                <tbody>
            ...
            <div className="sa-panel" style={{ animationDelay: '0.57s' }}>
              ...
              <table className="sa-table">
                <thead>
                  <tr><th>Membre</th><th>Montant</th><th>Statut</th><th>Date</th></tr>
                </thead>
                <tbody>
