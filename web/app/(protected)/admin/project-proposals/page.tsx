...
// ── Page ──────────────────────────────────────────────────────────────────────
export default function AdminProjectProposalsPage() {
      ...
      <div className="pp-wrap">
        ...
        <div className="pp-panel">
          <div className="pp-panel-head">
            ...
            <span className="pp-panel-title">Propositions reçues de mon antenne</span>
          ...
          <div className="pp-list">
            {loading ? (
              ...
              <div className="pp-empty">
                ...
                <div style={{ fontSize: '.75rem' }}>Les propositions soumises par vos membres apparaîtront ici.</div>
              </div>
            ) : (
              filtered.map((p, i) => {
