...
//
// v3.0.0 — Déplacé depuis app/page.tsx : ce composant reste 'use client' à
//          l'identique (rien ci-dessous n'a changé), app/page.tsx ne fait
//          plus que générer les métadonnées SEO puis rendre ce composant.
